...
def build_model( input_dim, hidden_dims, context_dim, num_blocks, conditional,layer_type='concatsquash',nonlinearity='relu'):
    def build_cnf():
...
def cnf(input_dim,dims,zdim,num_blocks):
    ...
    model = build_model(input_dim=input_dim, hidden_dims=dims, 
                        ...
                        layer_type='concatsquash',nonlinearity='tanh').cuda()
